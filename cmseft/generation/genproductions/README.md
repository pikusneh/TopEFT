# ARCHIVED [genproductions]
Generator fragments for MC production

**IMPORTANT**: Since April 2025, the repository is migrated to gitlab areas: 
- genproductions_scripts: https://gitlab.cern.ch/cms-gen/genproductions_scripts/ 
- genproductions_cards: https://gitlab.cern.ch/cms-gen/genproductions_cards/. 

This repo is kept open for bookkeeping reasons and no PR is going to be merged here.
